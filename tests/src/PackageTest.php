...
namespace Ixocreate\Test\Scheduler;

use Ixocreate\Application\Configurator\ConfiguratorRegistryInterface;
use Ixocreate\Application\Service\ServiceRegistryInterface;
use Ixocreate\Scheduler\Package;
...
{
    /**
     * @covers \Ixocreate\Scheduler\Package
     */
    public function testPackage()
    {
        ...
        $this->assertSame([TaskBootstrapItem::class], $package->getBootstrapItems());
